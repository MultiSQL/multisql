//! # multisql
//!
//! `multisql` is a SQL database engine fully written in Rust.
//! You can simply use `multisql` as an embedded SQL database using default storage
//! [sled](https://crates.io/crates/sled).
//! Or you can make your own SQL database using `multisql`, it provides parser & execution layer as
//! a library.
//!
//! `multisql` uses [sqlparser-rs](https://crates.io/crates/sqlparser) as a parser, and has own implementation of execution layer.
...
//!
//! ## Custom Storage
//! All you need to implement for `multisql` is implementing 3 traits (2 for functions, 1 for
//! running tests).
...
//! * [multisql-js](https://github.com/multisql/multisql-js)
//!
//! ## Tests
//! For making easy for developers to implement custom storages, `multisql` also provides integration
//! tests as a module.
//!
