use {
	crate::{
		...
		Context, ExecuteError, Payload, Result, StorageInner,
		MetaRecipe, PlannedRecipe, Value, executor::types::ColumnInfo
	},
	sqlparser::ast::{ObjectName, Expr, ColumnDef},
};
...
pub async fn delete(
	...
	let table_name = get_name(&table_name)?;
			let Schema { column_defs, indexes, .. } = storages[0]
				.1
